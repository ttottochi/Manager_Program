...
public class AllStatisticsController {
    public void AllhandleStatistics(Scanner sc, DataInputStream inputStream, DataOutputStream outputStream) throws IOException {
        ///시작 신호 보내기
        ...
        for (int i = 0; i < listSize; i++) {
            ...
            String store_name = inputStream.readUTF();
            String menu_name = inputStream.readUTF();
            long sum_order_price = inputStream.readLong();
